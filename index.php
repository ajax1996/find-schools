...
<?php include "sort.php";?>
      ...
      <?php
         ...
         // $sql="select * from schools where school_city='$city' order by school_rating";
          ...
          <div class="link">
            <a title="Visit Our Website" target="_blank" href="<?php echo $row['school_website']?>"><i class="fa fa-dribbble"></i></a> 
            <a title="More Info" target="_blank" href="details.php?var=<?php echo $row['school_id'];?>"><i class="fa fa-info-circle"></i></a>  
            <a title="Locate Us On Map"><button style="background-color: transparent;border: none;outline: 0" class="school-location" type="button" data-lat="<?php echo $row['school_lat'];?>" data-lng="<?php echo $row['school_long']?>"><i class="fa fa-map-marker"></i></button></a>
         </div>
            </div>
...
<script>
    ...
    var output = document.getElementById("lower_bound");
...
<script>
    ...
    var output = document.getElementById("upper_bound");
    output.innerHTML = slider.value;
